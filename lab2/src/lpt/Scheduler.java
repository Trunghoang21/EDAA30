...
public class Scheduler {
	...
	public Scheduler(Machine[] machineArray) {
		//Machine[] machines = machineArray; // här kan var ett möjligt fel
		this.machines = machineArray;
		// måste se till att det man skapa inte en ny machines obj i
		// contruktor 
	}
	...
	public void makeSchedule(List<Job> jobs) {
		...
		// en till fel här: tempJobList måste sorteras i den avtagande 
		//ordning
	...
	public void printSchedule() {
		...
		// en tid fel här for lopp kommer att räkna från 0 till 
		// list.length -1
		}
	}
}
